define([ "require", "underscore" ], function(require, _) {
    ...
    Globals.idealTimeoutSeconds = 900, Globals.isFullScreenView = !1, Globals.isLineageOnDemandEnabled = !1, 
    Globals.lineageNodeCount = 3, Globals.lineageDepth = 3, Globals.fromRelationshipSearch = !1, 
    Globals;
});