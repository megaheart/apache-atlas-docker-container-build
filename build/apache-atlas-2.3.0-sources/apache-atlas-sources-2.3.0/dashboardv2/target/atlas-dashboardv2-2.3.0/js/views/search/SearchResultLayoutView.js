    ...
    var SearchResultLayoutView = Backbone.Marionette.LayoutView.extend({
        ...
        tableRender: function(options) {
            ...
            that.REntityTableLayoutView) {
                ...
                Utils.getUrlState.isGlossaryTab() ? (this.ui.excludeSubtypes.hide(), this.ui.excludeSubClassifications.hide()) : "classification" !== this.fromView ? (this.ui.excludeSubtypes.show(), 
                this.ui.excludeSubClassifications.show()) : this.ui.excludeSubtypes.hide();
            }
        },
        ...
        getFixedDslColumn: function() {
            ...
            this.value && "basic" === this.value.searchType && this.searchTableColumns && void 0 !== this.searchTableColumns[this.value.type || this.value.tag] && (columnToShow = null == this.searchTableColumns[this.value.type || this.value.tag] ? [] : this.searchTableColumns[this.value.type || this.value.tag]), 
            col.Check = {
                name: "selected",
                label: "Select",
                cell: "select-row",
        ...
        addTagModalView: function(guid, multiple, entityCount) {
            ...
            require([ "views/tag/AddTagModalView" ], function(AddTagModalView) {
                new AddTagModalView({
                    ...
                    callback: function() {
                        that.multiSelectEntity = [], that.fetchCollection(), that.searchVent && that.searchVent.trigger("entityList:refresh");
                    },
