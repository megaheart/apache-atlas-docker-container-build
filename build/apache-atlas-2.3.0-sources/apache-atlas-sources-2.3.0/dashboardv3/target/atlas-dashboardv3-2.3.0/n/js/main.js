var modulesLoadCount = 0, showModuleLoader = function() {
    1 === modulesLoadCount && document.querySelector(".module-loader").classList.add("show-loader");
}, hideModuleLoader = function() {
    setTimeout(function() {
        0 === modulesLoadCount && (document.querySelector(".module-loader").className = "module-loader");
    }, 1e3);
};
...
require.config({
    ...
    onNodeCreated: function(node, config, moduleName, url) {
        ++modulesLoadCount, showModuleLoader(), node.addEventListener("load", function() {
            --modulesLoadCount, hideModuleLoader();
    ...
    this.relationshipDefCollection.modelAttrName = "relationshipDefs", App.appRouter = new Router({
    ...
    CommonViewFunction.userDataFetch({
        ...
        complete: function() {
            that.classificationDefCollection.fullCollection.comparator = function(model) {
                ...
                silent: !0
            }), that.classificationAndMetricEvent.trigger("Classification:Count:Update"), startApp();
        }
